...
export function Survivor5(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/assets/models/character/Survivor5.glb");
  const { actions } = useAnimations(animations, group);

  useEffect(() => {
    actions.S5_arguing.play();
  }, []);
...
useGLTF.preload("/assets/models/character/Survivor5.glb");