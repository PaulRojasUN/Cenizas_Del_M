...
export function Survivor2(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/assets/models/character/Survivor2.glb");
  const { actions } = useAnimations(animations, group);

  useEffect(() => {
    actions.S2_idle.play();
  }, []);
...
useGLTF.preload("/assets/models/character/Survivor2.glb");
