...
export function Survivor3(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/assets/models/character/Survivor3.glb");
  const { actions } = useAnimations(animations, group);

  useEffect(() => {
    actions.S3_arguing.play();
  }, []);
...
useGLTF.preload("/assets/models/character/Survivor3.glb");