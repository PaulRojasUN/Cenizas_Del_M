...
export function Survivor4(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/assets/models/character/Survivor4.glb");
  const { actions } = useAnimations(animations, group);

  useEffect(() => {
    actions.bpushing.play();
  }, []);
...
useGLTF.preload("/assets/models/character/Survivor4.glb");