...
export function Survivor1(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/assets/models/character/Survivor1.glb");
  const { actions } = useAnimations(animations, group);

  useEffect(() => {
    actions.S1_idle.play();
  }, []);
...
useGLTF.preload("/assets/models/character/Survivor1.glb");